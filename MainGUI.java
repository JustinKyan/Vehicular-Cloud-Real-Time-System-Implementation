...
public class MainGUI extends JFrame implements ActionListener {
	...
	public MainGUI(String title) {
		...
		// Filling our dropdown menu. addActionListener to see what choice user chooses.
		String[] list = { "", "Owner", "Client" };
		dropDownChoices = new JComboBox(list);
		dropDownChoices.addActionListener(this);

		// instantiate prompts for user-type selection on launch.
		...
		// Instantiating all text boxes. Set dimensions
